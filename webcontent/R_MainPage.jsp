...
<head>
<title>Data Integrity Audit Based On Data Blinding For Cloud And Fog Environment </title>
...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="logo">
        <h1><a href="index.html">Data Integrity Audit Based On Data Blinding For Cloud And Fog Environment </a></h1>
      </div>
      <div class="menu_nav">
        <ul>
    ...
    <div class="content_resize">
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <li><a href="R_FileRegistry.jsp"><span>View All Fog Server1 Registry Details </span></a></li>

          
          <li><a href="R_FileAuditingRegistry.jsp"><span>View All Public Auditing Registry</span></a></li>
		  <li><a href="R_FileTransRegistry.jsp"><span>View All File Registry Details</span></a></li>
		            <li><a href="R_FileAttackerRegistry.jsp"><span>View All Attacker Registry Details</span></a></li>
